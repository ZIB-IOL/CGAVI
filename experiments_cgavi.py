...
def performance():
    hp_agd = {'algorithm': 'oavi', 'oracle_type': 'AGD', 'psi': psis_, 'C': Cs_, 'term_ordering_strategy': tos_,
    ...
    hps = [hp_pcg_gb, hp_pcg_bb, hp_agd, hp_abm_gb, hp_abm_bb, hp_vca, hp_svm, hp_bpcg_gb, hp_bpcg_bb, hp_avi_gb,
           hp_avi_bb]
    for hp in hps:
