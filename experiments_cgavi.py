...
# Border plots
comparison_border_types("comparison_border_types", [hp_cgavi_ihb_gb, hp_cgavi_ihb_bb, hp_bpcg_wihb_gb, hp_bpcg_wihb_bb,
                                                    hp_abm_gb, hp_abm_bb], data_sets_performance_bb_)
